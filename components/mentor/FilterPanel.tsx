    ...
    <aside className="w-full lg:w-64 flex-shrink-0 space-y-6">
      ...
      <div>
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-sm font-medium text-purple-900">Sort by</span>
        </div>
        <select
          value={sort}
          onChange={(e) => onSortChange(e.target.value)}
          className="w-full text-sm border border-gray-300 rounded-lg px-3 py-2 bg-white focus:outline-none focus:ring-2 focus:ring-purple-500"
        >
      ...
      {/* Expertise tags */}
      <div>
        <span className="text-sm font-medium text-purple-900 mb-2 block">Expertise</span>
