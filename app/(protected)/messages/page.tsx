  ...
  if (conversations.length === 0) {
    return (
      <div className="max-w-2xl mx-auto">
        <div className="mb-6">
          <h1 className="font-display font-normal text-[2rem] leading-tight text-halo-ink">Messages</h1>
          <p className="text-halo-mist-body mt-1 text-sm">Your conversations with mentors and mentees.</p>
        </div>
        <div className="bg-white rounded-2xl border border-halo-rule p-12 flex flex-col items-center text-center">
          <div className="w-12 h-12 bg-halo-veil rounded-xl flex items-center justify-center mb-4">
            <MessageSquare className="w-6 h-6 text-halo-mist" />
          </div>
          <p className="text-sm font-medium text-halo-ink mb-1">No conversations yet</p>
    ...
    <>
      ...
      */}
      ...
      <div className="hidden md:flex h-[calc(100vh-8rem)] rounded-xl overflow-hidden border border-halo-rule bg-white shadow-sm">
        {/* Conversation list */}
        <div className="w-72 flex-shrink-0 border-r border-halo-rule overflow-y-auto">
          <div className="px-4 py-3 border-b border-halo-rule">
            <h2 className="text-sm font-semibold text-halo-ink">Messages</h2>
          </div>
          <ConversationList
        ...
        <div className="flex-1 flex flex-col min-w-0">
          {activeMentorshipId && currentUserId && activeConversation ? (
            ...
            <div className="flex-1 flex items-center justify-center text-halo-mist-body text-sm">
      ...
      <div className="md:hidden flex flex-col h-[calc(100vh-6rem)] rounded-xl overflow-hidden border border-halo-rule bg-white shadow-sm">
        {mobileView === 'list' ? (
          <>
            <div className="px-4 py-3 border-b border-halo-rule">
              <h2 className="text-sm font-semibold text-halo-ink">Messages</h2>
