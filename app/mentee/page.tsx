...
export const metadata: Metadata = {
  title: 'Mentable for students: find and build a real mentorship',
  description: 'Find someone who has already done the work you want to do.',
};
  ...
  return (
    <div className="min-h-screen bg-halo-ivory flex flex-col">
      ...
      <main className="flex-1">
        <section className="py-20 sm:py-24 px-6 lg:px-10" aria-labelledby="mentee-heading">
